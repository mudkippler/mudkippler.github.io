...
(async () => {
  ...
  const helixMainHp = phaseHp('helix', 'main', 2);
  check(s.boss.maxHp === helixMainHp, `boss HP now matches the new encounter (helix x2 players=${helixMainHp}, got ${s.boss.maxHp})`);
